...
　　林友芳于2012年10月19日修改本模块，email: yflin@bjtu.edu.cn
	...
	韩升于2018年2月26日修改本模块，email：shhan@bjtu.edu.cn
...
......
*/
void TestCoundWords();//查询单词并输出单词的总函数，

void FindWords(FILE *fp,NODE *pNode);//找出单词

void PrintWords(NODE *pNode);//输出单词
